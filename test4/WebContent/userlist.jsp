...
<body>
	...
	<div id="userListTb" style="padding:2px 5px;">
		<a href="javascript:void(0)" class="easyui-linkbutton"
			iconCls="icon-edit" plain="true" onclick="SetIsEnableUser(1);">启用用户</a>
		<a href="javascript:void(0)" class="easyui-linkbutton"
			iconCls="icon-remove" onclick="SetIsEnableUser(0);" plain="true">禁用用户</a>
	</div>
	...
	<div id="searchUserListTb" style="padding:4px 3px;">
		<form id="searchUserListForm">
			<div style="padding:3px ">
				客户名称&nbsp;&nbsp;<input class="easyui-textbox" name="search_loginName"
					id="search_loginName" style="width:110px" /><a
	...
	<script type="text/javascript">
		...
		function searchUsers() {
			var loginName = $('#search_loginName').textbox("getValue");
