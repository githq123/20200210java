...
<body>
	...
	<div id="adminListTb" style="padding:2px 5px;">
		<a href="javascript:void(0)" class="easyui-linkbutton"
			iconCls="icon-add" onclick="openAddAdminDlg();" plain="true">添加管理员</a>
		<a href="javascript:void(0)" class="easyui-linkbutton"
			iconCls="icon-edit" plain="true" onclick="editPowers();">设置/修改管理员权限</a>
	</div>

	<!-- 设置/修改管理员权限的对话框  -->
	<div id="powerDlg" class="easyui-dialog" title="设置/修改管理员权限"
				...
				<table cellpadding="5">
					<tr>
						...
						<td><ul id="powerTree"></ul> <input type="hidden"
							name="editAdminId" id="editAdminId" style="width:10px" /></td>
					</tr>
				</table>
			</form>
				...
				<table cellpadding="5">
					...
					<tr>
						...
						<td><input class="easyui-textbox" type="text" id="loginPwd"
							name="loginPwd" data-options="required:true"></input></td>
					</tr>
				</table>
			</form>
			<div style="text-align:center;padding:5px">
	...
	<script type="text/javascript">
		...
		function editPowers() {
			...
			if (rows.length > 0) {
				...
				// 打开“设置/修改权限”对话框
				$("#powerDlg").dialog("open").dialog('setTitle', '设置/修改管理员权限');
				// 通过id为“editAdminId”的隐藏文本域保存选中管理员编号
		...
		// 获取“设置/修改管理员权限”对话框中Tree控件上选中的功能节点的id号
		function getChecked() {
